...
export const NORMATIVA_APLICADA: NormaAplicada[] = [
  ...
  { codigo: 'CNIC-IRM-PARTICULAR-0..4', descripcion: 'Tipos IRM cuenta particular (por IA)', valor: '0% / 0.5% / 1.5% / 3% / 5%' },
  { codigo: 'CNIC-IRM-COMPARTIDA-0..4', descripcion: 'Tipos IRM cuenta compartida (por IA)', valor: '0% / 0.75% / 2% / 4% / 6%' },
  { codigo: 'CNIC-IRM-EMPRESA-0..4', descripcion: 'Tipos IRM cuenta empresa (por IA)', valor: '0% / 1% / 3% / 6% / 9%' },
