...
import { generarPdfFichaEntidad, generarPdfFactura } from '../../lib/pdf';
...
export default function EntidadDetail() {
  ...
  const colsFact: Column<FacturaEmitida>[] = [
    ...
    { key: 'pdf', header: '', render: (f) => <Button size="sm" variant="outline" onClick={() => generarPdfFactura(f)}>PDF</Button> },
  ];
