...
type DocForm = { codigo: string; titulo: string; tipo: string; categoria: string; seccion: string; familia: string; departamento: string; organoResponsable: string; fechaPropuesta: string; fechaAplicacion: string; fechaEntradaVigor: string; contenidoMd: string; notasCambio: string; cnicRefs: string };
const EMPTY_DOC: DocForm = { codigo: '', titulo: '', tipo: 'cni', categoria: 'capitulo', seccion: '', familia: '', departamento: '', organoResponsable: '', fechaPropuesta: '', fechaAplicacion: '', fechaEntradaVigor: '', contenidoMd: '', notasCambio: '', cnicRefs: '' };
...
export default function Bop() {
  ...
  function seleccionar(d: BopDocumento) {
    setSelectedId(d.id);
    setDocForm({ codigo: d.codigo, titulo: d.titulo, tipo: d.tipo, categoria: d.categoria, seccion: d.seccion || '', familia: d.familia || '', departamento: d.departamento || '', organoResponsable: d.organoResponsable || '', fechaPropuesta: d.fechaPropuesta || '', fechaAplicacion: d.fechaAplicacion || '', fechaEntradaVigor: d.fechaEntradaVigor || '', contenidoMd: d.contenidoMd || '', notasCambio: '', cnicRefs: (d.cnicRefs || []).map((r) => r.codigo).join(', ') });
